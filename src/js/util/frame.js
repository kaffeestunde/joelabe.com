...
export default function Frame(params) {
  ...
  if (params.hasOwnProperty('zoomable')) {
    this._zoomable = params.zoomable
  } else {
    this._zoomable = true
  }
...
Frame.prototype.loadImg = function(img) {
  ...
  if (this.$frame.find('div.img-container').length) {
    ...
    var containerHtml = "<div style='height:100%;width:100%;overflow:hidden;' class='img-container'></div>"
    var el = "<img style='max-width: none;' src='" + src + "' />"
